...
export const TEAMS = [
  ...
  { id: 'stl', name: 'St. Louis Ironclads', city: 'St. Louis', conference: 'Eastern Conference', division: 'East Rivers', colors: ['#002f6c', '#c60c30'] },
  { id: 'bng', name: 'Cincinnati Bengals Bluff', city: 'Cincinnati', conference: 'Eastern Conference', division: 'East Rivers', colors: ['#fb4f14', '#0a0a0a'] },
  ...
  { id: 'crd', name: 'Phoenix Cardinals Peak', city: 'Phoenix', conference: 'Western Conference', division: 'West Coast', colors: ['#97233f', '#000000'] },
  { id: 'lng', name: 'Dallas Longhorns', city: 'Dallas', conference: 'Western Conference', division: 'West South', colors: ['#08183b', '#a5acaf'] },
  { id: 'txn', name: 'Houston Titans Reach', city: 'Houston', conference: 'Western Conference', division: 'West South', colors: ['#03202f', '#a71930'] },
  { id: 'jag', name: 'Jacksonville Jaguars Bay', city: 'Jacksonville', conference: 'Western Conference', division: 'West South', colors: ['#006778', '#d7a22a'] },
  { id: 'tnt', name: 'Nashville Titans', city: 'Nashville', conference: 'Western Conference', division: 'West South', colors: ['#0c2340', '#4b92db' ] },
  ...
  { id: 'grz', name: 'Chicago Grizzle', city: 'Chicago', conference: 'Western Conference', division: 'West Heartland', colors: ['#004c54', '#a5acaf'] },
